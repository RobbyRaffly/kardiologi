...
class dashADDECG extends StatefulWidget {
  dashADDECG() : super();

  // final String title = "File Operations";
  @override
  _dashADDECGPage createState() => _dashADDECGPage();
}

class _dashADDECGPage extends State<dashADDECG> {
  ...
  void ambilDataDokter() async {
    ...
    setState(() {
      daftardokterlist = jsonDecode(response.body);
      print(daftardokterlist);
    });
  }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  Widget listDaftarDokter(BuildContext context, int index) {
    //print(daftardokterlist[index]);
        ...
        child:
          ...
          CircleAvatar(
            backgroundImage: NetworkImage(
                '${link}${daftardokterlist[index]["profilePicture"]}'),
            maxRadius: 25,
          ),
          Container(
              child: Flexible(
                  child: Container(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            Text('${daftardokterlist[index]["nama_lengkap"]}',
                                maxLines: 1,
                            ...
                            SizedBox(height: 10),
                            // Text('${daftardokterlist[index]["hospital"]}',
                            //     maxLines: 1,
                            //     overflow: TextOverflow.ellipsis,
    ...
    return showDialog<void>(
        ...
        builder: (BuildContext context) {
          return Container(
            margin: EdgeInsets.fromLTRB(30, 150, 30, 150),
            color: Colors.white,
            child: list_dokter(context),
          );
        });
  }

  Widget list_dokter(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Kirim ke dokter',
            style: TextStyle(
      ...
      body: ListView.builder(
          ...
          shrinkWrap: true,
          itemCount: daftardokterlist == null ? 0 : daftardokterlist.length,
          itemBuilder: (BuildContext context, int index) =>
              listDaftarDokter(context, index)),
    ));
  }
